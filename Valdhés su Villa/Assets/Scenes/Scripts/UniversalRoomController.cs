...
public class UniversalRoomController : MonoBehaviour
{
    ...
    private readonly Vector3[] cameraPositions = {
        new Vector3(3.105f, 2.872f, -4.943f),  // ��� 0: North-West
        new Vector3(-4.943f, 2.872f, -3.105f), // ��� 1: North-East  
        new Vector3(-3.105f, 2.872f, 4.943f),  // ��� 2: South-East
        new Vector3(4.943f, 2.872f, 3.105f)    // ��� 3: South-West
    };

    // ���������� �������� ������ ��� 4 �����������
    private readonly Vector3[] cameraRotations = {
        new Vector3(17f, 310f, 0f),  // ��� 0: North-West
        new Vector3(17f, 40f, 0f),   // ��� 1: North-East
        new Vector3(17f, 130f, 0f),  // ��� 2: South-East
        new Vector3(17f, 220f, 0f)   // ��� 3: South-West
    };
